...
../../../../../PackBitmap/PackBitmap/bin/Debug/PackBitmap.exe -l=ada -c=8 Ananas Ananas.bmp
...
arm-none-eabi-gcc -gdwarf-2 -O3 --function-sections -march=armv7e-m -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=fpv4-sp-d16 -I. -I/usr/local/arm-ada/lib-appli/ -c ananas_res.ads
...
arm-none-eabi-gcc -gdwarf-2 -O3 --function-sections -march=armv7e-m -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=fpv4-sp-d16 -I. -I/usr/local/arm-ada/lib-appli/ -c pac_gum.ads
